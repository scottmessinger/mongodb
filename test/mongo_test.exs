defmodule Mongo.Test do
  ...
  test "find_one_and_update!", c do
    ...
    assert_raise Mongo.Error, fn ->
      Mongo.find_one_and_update!(c.pid, coll, %{_id: 2}, %{}, [sort: %{hi: -100}])
    end
  end
  ...
  test "find_one_and_replace!", c do
    ...
    assert_raise Mongo.Error, fn ->
      Mongo.find_one_and_replace!(c.pid, coll, %{_id: 2}, %{}, [sort: %{hi: -100}])
    end
  end
  ...
  test "find_one_and_delete!", c do
    ...
    assert_raise Mongo.Error, fn ->
      Mongo.find_one_and_delete!(c.pid, coll, nil, [sort: %{hi: -100}])
    end
  end
